...
let
  ...
  hsPkgs = nixpkgsSuper.haskell.packages.${ghcVersion}.override {
    overrides = self: super: {
      ...
      scalpel = pkgs.haskell.lib.dontCheck (self.callHackageDirect {
        pkg = "scalpel";
        ver = "0.6.2";
        sha256 = "1k8py5jldf1cz3bnnan1r15fcb2m8s14awsnykfms9ggv225ka57";
      } {});
      scalpel-core = pkgs.haskell.lib.dontCheck (self.callHackageDirect {
        pkg = "scalpel-core";
        ver = "0.6.2";
        sha256 = "0k2154l9570rx0vm9jdf7qr0j7qfag8wvc6qh3pyb19jh1gji4n6";
      } {});
